...
module.exports = {
  saveKeyin: (uid,ref,barcode_orig,owner,phone_number,operator_id_re,rawData) => {
    ...
    var sql ="INSERT INTO parcel_keyin_data (uid,ref,barcode,owner,phone_number,operator_id,record_created_at,raw_data) VALUES (?,?,?,?,?,?,?,?)";
    var data=[uid,ref,barcode_orig,owner,phone_number,operator_id_re,new Date(),rawData];
  ...
  saveKeyinTemp: (uid,ref,barcode_orig,owner,phone_number,operator_id_re,rawData) => {
    ...
    // var dateTimeString = moment(new Date()).format("YYYY-MM-DD HH:mm:ss",true);
    var sql ="INSERT INTO parcel_keyin_data_temp (uid,ref,barcode,owner,phone_number,operator_id,record_created_at,raw_data) VALUES (?,?,?,?,?,?,?,?)";
    var data=[uid,ref,barcode_orig,owner,phone_number,operator_id_re,new Date(),rawData];
  ...
  updateKeyinTemp: (uid,ref,barcode_orig,owner,phone_number,operator_id,rawData) => {
    // let dateNow = new Date().toLocaleString("en-US", {timeZone: "Asia/Bangkok"});
    // var dateTimeString = moment(new Date()).format("YYYY-MM-DD HH:mm:ss",true);
    var sql ="UPDATE parcel_keyin_data_temp SET uid=?,ref=?,barcode=?,owner=?,phone_number=?,operator_id=?,raw_data=?,record_created_at=? WHERE barcode =?";
    var data=[uid,ref,barcode_orig,owner,phone_number,operator_id,rawData,new Date(),barcode_orig];
  ...
  updateReceiver: (barcode_orig,label_parcel_type,label_name,label_phone_number,label_address,label_district_id,district_name,label_amphur_id,amphur_name,label_province_id,province_name,label_zipcode,source) => {
    let sql ="UPDATE billing_receiver_info SET parcel_type=?,receiver_name=?,phone=?,receiver_address=?,district_id=?,district_name=?,amphur_id=?,amphur_name=?,province_id=?,province_name=?,zipcode=?,remark=? WHERE tracking=?";
    var data=[label_parcel_type,label_name,label_phone_number,label_address,label_district_id,district_name,label_amphur_id,amphur_name,label_province_id,province_name,label_zipcode,source,barcode_orig]; 
    return new Promise(function(resolve, reject) {
  ...
  updateBillingItem: (barcode_orig,label_zipcode,label_parcel_type,source) => {
    let sql ="UPDATE billing_item SET zipcode=?,parcel_type=?,source=? WHERE tracking=?";
  ...
  checkDataReceiver: (barcode_orig) => {
    let sql ="SELECT tracking,parcel_type,zipcode,remark FROM billing_receiver_info WHERE tracking = ?";
    var data=[barcode_orig];
  ...
  saveBillingItemTemp: (barcode_orig, zipcode, label_parcel_type, source) => {
    ...
    var sql ="INSERT INTO billing_item_temp (tracking,zipcode,parcel_type,source) VALUES (?,?,?,?)";
  ...
  saveBillingReceiverTemp: (barcode_orig,label_parcel_type,label_name,label_phone_number,label_address,label_district_id,district_name,label_amphur_id,amphur_name,label_province_id,province_name,label_zipcode,source) => {
    var sql = "INSERT INTO billing_receiver_info_temp(tracking, parcel_type, receiver_name, phone, receiver_address, district_id, district_name, amphur_id, amphur_name, province_id, province_name, zipcode, remark) " +
    "VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)";
    var data=[barcode_orig,label_parcel_type,label_name,label_phone_number,label_address,label_district_id,district_name,label_amphur_id,amphur_name,label_province_id,province_name,label_zipcode,source];
